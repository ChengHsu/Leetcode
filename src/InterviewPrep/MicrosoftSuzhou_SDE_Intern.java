 ...
 */
public class MicrosoftSuzhou_SDE_Intern {
    /**
     * 青蛙跳台阶:
...
/****************************************************LEETCODE Explore Part: BST ***************************************************************/
    ...
    class BSTIterator {
         ...
         */
        public int next() {
            TreeNode currSmallest = stack.pop();
            TreeNode curr = currSmallest;
            if (curr.right != null) {
                curr = curr.right;
                while (curr != null) {
                    stack.push(curr);
    ...
    /**
     * LC#701. Insert in a Binary Search Tree
     * time: O(logn)
     *
     * @param root
     * @param val
    ...
    public TreeNode deleteNode(TreeNode root, int key) {
        if (root == null)
            ...
            // 2. replace it with its successor
            // 3. make sure to also delete its successor
    ...
    public TreeNode findSuccessor(TreeNode root) {
        HashMap<Integer, Integer> map = new HashMap<>();
        StringBuffer str = new StringBuffer("xc");
        String[] strArr = str.toString().split(" ");
        TreeNode curr = root.right;
        // mode to curr's left until curr's left is null, curr is the successor
