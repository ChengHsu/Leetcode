...
/**
 * @Number: #299. Bulls and Cows
 * @Descpription: You are playing the following Bulls and Cows game with your friend: You write down a number and ask your friend to guess what the number is.
        ...
        for (int i = 0; i < secret.length(); i++) {
            if (secret.charAt(i) == guess.charAt(i))
                ...
                if (numbers[guess.charAt(i) - '0'] > 0)
                    cows++;
                // if the number matches at the same position, numbers[that position] will always be 0
